...
let readTestResultXML = readXML('./test-results.xml');
let readCloverXML = readXML('./coverage/footBallTournament/clover.xml');
...
function getCloverCount(cloverJson) {
  ...
  //console.log(cloverJson.coverage.project.metrics._attributes.packages);//12
  ...
  // console.log(total,'total');//554
  // console.log(uncovered_count,'uncovered_count');//535

 
  const normalization = 150; // set your initial uncovered_count in normalization
  clover_sucess_count = normalization -  parseInt((uncovered_count/(total-19)) * 150 );
  clover_err_count = parseInt((uncovered_count/(total-19)) * 150 );
  // console.log(clover_sucess_count,clover_err_count)
